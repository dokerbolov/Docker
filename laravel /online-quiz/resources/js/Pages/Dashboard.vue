            ...
            <div class="col-lg-8 mb-6 order-0">
                <div class="card">
                    <div class="d-flex align-items-start row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary mb-3">Welcome {{ page.props.auth.user.name }}! 🎉</h5>
                                <p class="mb-6">
                                    You have successfully logged in to your new Vue & Inertia Sneat dashboard.<br />Customize it to fit your needs!
                                </p>
                            </div>
                        </div>
